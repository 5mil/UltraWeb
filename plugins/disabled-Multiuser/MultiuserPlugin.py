        ...
        if user_created:
            ...
            inject_html = """
                ...
                <script>
                 ...
                 hello_message+= "<small>This site is allows you to browse utraweb content, but if you want to secure your account <br>"
                 hello_message+= "and help to make a better network, then please run your own <a href='https://github.com/Helloutraweb/utraweb' target='_blank'>utraweb client</a>.</small>"
                 setTimeout(function() {
